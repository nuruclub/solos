...
function init() {
    var mapOptions = {
        center: new google.maps.LatLng(40.786425, -73.954174),
        zoom: 15,
        zoomControl: false,
...
//            animation: google.maps.Animation.BOUNCE,
	...
	// Create an InfoWindow for the marker
		var contentString = "<p class='map-info'><strong>New York City</strong> <br/> Manhattan<br/> +1 347-380-9808</p>";	// HTML text to display in the InfoWindow
